...
const increaseScore = () => {
  ...
  currentScore = parseInt(score.innerHTML, 10);
...
const move = direction => {
  ...
  switch (direction) {
    case 'up':
      head[1] = head[1] === 1 ? worldSize: head[1] - 1; break;
    case 'down':
      head[1] = head[1] === worldSize ? 1: head[1] + 1; break;
    case 'left':
      head[0] = head[0] === 1 ? worldSize: head[0] - 1; break;
    case 'right':
